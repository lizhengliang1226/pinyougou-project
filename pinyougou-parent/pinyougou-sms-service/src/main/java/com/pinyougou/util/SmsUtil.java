...
public class SmsUtil {
    ...
    //签名
    private String signName = "品优购";

    //    private String templateCode="SMS_216401750";
    // TODO 此处需要替换成开发者自己的AK(在阿里云访问控制台寻找)
    @Value("${ACCESS_KEY_ID}")
    private String accessKeyId;
//    private String accessKeyId = "LTAI5tBRPrDCKpKBuJW199G6";
    @Value("${ACCESS_KEY_SECRET")
    private String accessKeySecret ;
//    private String accessKeySecret = "ZMRIG38tbvtWYpE7UbcwjYjRnkhq2M";
